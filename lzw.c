...
int main (int argc, char *argv[])
{
    ...
    //verificação se os parametros foram passados dentro da conformidade do problema
...
int codifica(char *arqEntrada, char* arqSaida)
{
    ...
    {
        printf("Programa não pôde abrir o arquivo %s.\n", arqEntrada);
        return 2;
    }
    ...
    if (arquivoSaida == NULL)
    {
        ...
        printf("Programa não pôde criar/abrir o arquivo %s.\n", arqSaida);
        return 3;
    }
    ...
    while(fread(&c, sizeof(char), 1, arquivoEntrada))
    {
        ...
        else
        {
            ...
            {
                printf("Tamanho máximo do dicionário excedido\n");
                return 7;
            }
        }
    }
    ...
    if(strcmp(stringTemporaria, "")!=0)
    {
        ...
        {
            printf("Tamanho maximo do dicionario excedido\n");
            return 7;
        }
    }
